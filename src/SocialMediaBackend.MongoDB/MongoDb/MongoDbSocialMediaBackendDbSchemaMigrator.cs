...
public class MongoDbSocialMediaBackendDbSchemaMigrator : ISocialMediaBackendDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbSocialMediaBackendDbSchemaMigrator(IServiceProvider serviceProvider)
    {
